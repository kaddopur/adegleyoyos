loadPartners = ->
  coop = [{name: 'Adegleyoyos露天拍賣', site: 'http://bit.ly/adegle66',              logo: 'ruten.png'},
  ...
  asia = [{name: '28SPIN',            site: 'http://www.28spin.com/v5/',                    logo: '28spin.png'},
          ...
          {name: 'yoyoplace悠悠地帶', site: 'http://worldyoyo.taobao.com/',                 logo: 'yoyoplace.png'},
  ...
  europe = [{name: 'Euro-Yo',    site: 'http://www.euro-yo.com/',               logo: 'euroyo.png'},
            ...
            {name: 'yoyo.ua',    site: 'http://www.yoyo.ua/',                   logo: 'yoyoua.png'},
